...
//CRIAR A PRÓXIMA CONTA A PAGAR CASO EXISTA RECORRENCIA / FREQUENCIA
	...
	if(@$dias_frequencia > 0){
		$pdo->query("INSERT INTO $tabela set empresa = '$id_empresa', tipo = 'Conta', descricao = '$descricao', pessoa = '$pessoa', valor = '$valor', data_lanc = curDate(), data_venc = '$nova_data_vencimento', frequencia = '$frequencia', arquivo = '$arquivo', pago = 'Não'");
